...
<%@ page contentType="text/html;charset=UTF-8" language="java" %><html>
  ...
  <table cellpadding="0" cellspacing="0">
      <tr>
          <td style="width: 150px;vertical-align: top;">Require password</td><td><input id="pwswitch" name="usepw" type="checkbox" onclick="disable();" /><span class="note">Even though the url is hard to guess, some browsers may exchange the url data<br />with third parties.To protect sensitive data, additional password is a good idea. <br />This password will be required before user is allowed to download the file.</span></td>
      </tr>
      <tr>
