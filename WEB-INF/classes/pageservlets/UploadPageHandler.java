            ...
            try {
                ...
                if ( req != null && req.isMultipart()){
                   ...
                   if (req.getFile("file") != null ){
                    ...
                    MultipartRequest.SessionData data = (MultipartRequest.SessionData) request.getSession().getAttribute(req.getParameter("upid"));
                    data.setStatus("Calculating md5sum");
                    request.getSession().setAttribute(req.getParameter("upid"),data);
                    String md5 = MD5OutputStream.getMD5(file.getFile().getPath());
                    CustomLogger.logme(this.getClass().getName(),"MD5: " +  md5);
                    ...
                    if ( req.getParameter("usepwt")!=null && req.getParameter("usepwt").equals("on")){
                        savedfile.setPassword(utils.Jcrypt.crypt(req.getParameter("passwordt")));
                    }
                    savedfile.save(conn);
