...
public class Jcrypt {
    ...
    public  Jcrypt(String arg){
        String result = null;
        String salt = random(2,0,0,true,true,null,new Random());
        CustomLogger.logme(this.getClass().getName(),"Salt is " + salt);
        result = Jcrypt.crypt(salt,arg);
        CustomLogger.logme(this.getClass().getName(),"Crypted password is: " + result);
